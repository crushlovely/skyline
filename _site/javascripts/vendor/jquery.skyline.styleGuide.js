        ...
        $.each(commentLines, function(l){
          ...
          if (flag_class == true){
            ...
            if (line.substring(0, 3) == "  @" && l == 2) {
              ...
              $(".sg-main").append(markup);
              // add to nav
              console.log("adding to nav [", line.substr(3), "]");
          ...
          if (flag_category == true) {
            ...
            if (line.substring(0, 3) == "  @" && l == 2) {
              ...
              $(".sg-main").append(markup);
              // add to sub nav
              curr_catName = line.substr(3),
              curr_catSlug = curr_catName.replace(/\s/g, "-");
              $(".sg-nav__links").append("<li><a href='#"+curr_catSlug+"'>"+curr_catName+"</a><li>");
            }
